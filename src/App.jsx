...
const NavBar = () => {
  return (
    <nav style={{ width: '100%', backgroundColor: '#333', padding: '1rem 0', position: 'fixed', top: 0, zIndex: 1000 }}>
      <ul style={{ display: 'flex', justifyContent: 'center', margin: 0, padding: 0, listStyle: 'none' }}>
        <li style={{ margin: '0 1rem' }}>
          <a href="#home" style={{ color: '#f2f2f2', textDecoration: 'none' }}>Home</a>
        </li>
        <li style={{ margin: '0 1rem' }}>
          <a href="#about" style={{ color: '#f2f2f2', textDecoration: 'none' }}>About</a>
        </li>
        <li style={{ margin: '0 1rem' }}>
          <a href="#events" style={{ color: '#f2f2f2', textDecoration: 'none' }}>Events</a>
        </li>
        <li style={{ margin: '0 1rem' }}>
          <a href="#alumni" style={{ color: '#f2f2f2', textDecoration: 'none' }}>Alumni</a>
        </li>
        <li style={{ margin: '0 1rem' }}>
          <a href="#gallery" style={{ color: '#f2f2f2', textDecoration: 'none' }}>Gallery</a>
        </li>
      </ul>
    </nav>
  );
